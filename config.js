...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || 923034757172',
    ...
    ANTI_BOT: process.env.ANTI_BOT || '.menu',
    ANTISPAM_COUNT: process.env.ANTISPAM_COUNT || '5/10', // msgs/sec
    ...
    RG: process.env.RG || 923034757172-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Professor;Jin;923034757172;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "PROFESSOR",
